...
>>>>>>> parent of d3118c3... åˆ¤å®šç³»æœªå®ŒæˆçŠ¶æ…‹ã€ä¸€æ—¦ãƒ—ãƒƒã‚·ãƒ¥
	...
	// Ž©g(Circle)‚Æ‘ŠŽè(Box)‚Ì”»’è other:”»’è‚µ‚½‚¢‘ŠŽè(BoundingBox) return:”»’èŒ‹‰Ê(bool)
	virtual bool intersects(BoundingBox & other) override;
	// Ž©g(Circle)‚Æ‘ŠŽè(Capsule)‚Ì”»’è other:”»’è‚µ‚½‚¢‘ŠŽè(BoundingCapsule) return:”»’èŒ‹‰Ê(bool)
	virtual bool intersects(BoundingCapsule & other) override;
	// Ž©g(Circle)‚Æ‘ŠŽè(Segment)‚Ì”»’è other:”»’è‚µ‚½‚¢‘ŠŽè(BoundingSegment) return:”»’èŒ‹‰Ê(bool)
	virtual bool intersects(BoundingSegment & other) override;
	// Ž©g(Circle)‚Æ‘ŠŽè(Circle)‚Ì”»’è other:”»’è‚µ‚½‚¢‘ŠŽè(BoundingCircle) return:”»’èŒ‹‰Ê(bool)
	...
	//Ž©g(Circle)‚ðˆÚ“®‚·‚é position:ˆÚ“®—Ê(Vector2) return:ˆÚ“®‚µ‚½Œ‹‰Ê(BoundingCircle)
	BoundingCircle translate(const Vector2& position) const;
	//Ž©g(Box)‚ð•ÏŒ`‚·‚é center:’†S“_(Vector2) circleRadius:”¼Œa(float) return:•ÏŒ`‚µ‚½Œ‹‰Ê(BoundingCircle)
