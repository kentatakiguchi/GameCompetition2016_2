...
public:
	...
	// Ž©g(Box)‚Æ‘ŠŽè(Segment)‚Ì”»’è other:”»’è‚µ‚½‚¢‘ŠŽè(BoundingSegment) return:”»’èŒ‹‰Ê(bool)
	virtual bool intersects(BoundingSegment & other) override;
	// Ž©g(Box)‚Æ‘ŠŽè(Circle)‚Ì”»’è other:”»’è‚µ‚½‚¢‘ŠŽè(BoundingCircle) return:”»’èŒ‹‰Ê(bool)
