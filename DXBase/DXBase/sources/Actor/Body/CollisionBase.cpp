...
CollisionBase::CollisionBase() :box_(), capsule_(), circle_(), segment_(), type_(NoneCol), enabled_(false)
{
}
...
CollisionBase::CollisionBase(const Vector2 & topLeft, const Vector2 & topRight, const Vector2 & bottomLeft, const Vector2 & bottomRight) :
	box_(), capsule_(), segment_(), circle_(), type_(BoxCol), enabled_(false)
{

}

CollisionBase::CollisionBase(Vector2& startPoint, Vector2& endPoint, float capsuleRadius) :
	box_(), capsule_(), segment_(), circle_(), type_(CapsuleCol), enabled_(false)
{

}

CollisionBase::CollisionBase(Vector2 & center, float circleRadius) :
	circle_(), box_(), capsule_(), segment_(), type_(CircleCol), enabled_(false)
{
}

CollisionBase::CollisionBase(Vector2 & startPoint, Vector2 & endPoint) :
	box_(), capsule_(), segment_(), circle_(), type_(SegmentCol), enabled_(false)
{
...
CollisionBase CollisionBase::GetBox() const
{
	return CollisionBase();
}

CollisionBase CollisionBase::GetCapsule() const
{
	return CollisionBase();
}

CollisionBase CollisionBase::GetCircle() const
{
	return CollisionBase();
}

CollisionBase CollisionBase::GetSegment() const
{
	return CollisionBase();
}
