...
PlayerAnimation2D::PlayerAnimation2D(const std::string& name) {
	...
	if (name == "PlayerBody1") {
		...
		add(PlayerAnimID::DEATH,	 ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_BUTTY_DEATH),		256, 8, 2, 0);
		add(PlayerAnimID::DAMAGE,	 ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_BUTTY_DAMAGE),	256, 8, 2, 0);
		add(PlayerAnimID::DIV_IDLE,	 ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_BUTTY_DIV_IDLE),	256, 8, 2, 0);
		add(PlayerAnimID::DIV_MOVE,	 ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_BUTTY_DIV_MOVE),	256, 8, 2, 1);
		add(PlayerAnimID::TURN,		 ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_BUTTY_TURN),		256, 8, 2, 5);
		add(PlayerAnimID::SWIM_TURN, ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_BUTTY_SWIM_TURN),	256, 8, 2, 5);
	}
	//retty
	if (name == "PlayerBody2") {
		...
		add(PlayerAnimID::DEATH,	 ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_RETTY_DEATH),		256, 8, 2, 0);
		add(PlayerAnimID::DAMAGE,	 ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_RETTY_DAMAGE),	256, 8, 2, 0);
		add(PlayerAnimID::DIV_IDLE,  ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_RETTY_DIV_IDLE),	256, 8, 2, 0);
		add(PlayerAnimID::DIV_MOVE,  ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_RETTY_DIV_MOVE),	256, 8, 2, 1);
		add(PlayerAnimID::TURN,		 ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_RETTY_TURN),		256, 8, 2, 5);
		add(PlayerAnimID::SWIM_TURN, ResourceLoader::GetInstance().getTextureID(TextureID::PLAYER_RETTY_SWIM_TURN), 256, 8, 2, 5);
	}
}
